...
void SteppingAction::UserSteppingAction(const G4Step* aStep)
{
  ...
  if(aStep->GetPostStepPoint()->GetProcessDefinedStep()->GetProcessName().contains("Inelastic")){
    theTrackingAction->Primary=0;
